          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text("Sign In", style: Loign_UI_Constants.styleForText),
              ),
              Container(
                                ...
                                onPressed: () {
                                  ...
                                  if (snapshot.hasData) {
                                    if (snapshot.data) {
                                      ...
                                      showDefaultSnackbar(
                                          context, UsernameConst.EMAIL_INVALID);
                                    }
                                  }
                                });
                          })
                                ...
                                onPressed: () {
                                  ...
                                  if (snapshot.hasData) {
                                    if (snapshot.data) {
                                      ...
                                      showDefaultSnackbar(
                                          context, UsernameConst.PASS_INVALID);
                                    }
                                  }
                                });
                          }),
