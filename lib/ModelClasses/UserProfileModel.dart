class UserProfileModel {
  ...
  UserProfileModel({String massage, bool status, List<UserProfile> data}) {
...
class UserProfile {
  ...
  dynamic _role;
  String _photo;
  dynamic _assignmentRole;
  String _organization;
  String _supervisor;
  dynamic _lastLogin;
  dynamic _recentLogin;
  dynamic _column1;
  dynamic _column2;
  dynamic _column3;
  dynamic _column4;
  ...
  set assignmentRole(dynamic assignmentRole) => _assignmentRole = assignmentRole;
