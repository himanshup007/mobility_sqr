...
class PerDiemModel {
  ...
  PerDiemModel(
    ...
    this._perDiem = perDiem;
    this._accommodationLimit = accommodationLimit;
  ...
  set perDiem(String perDiem) => _perDiem = perDiem;
  String get accommodationLimit => _accommodationLimit;
  set accommodationLimit(String accommodationLimit) =>
      _accommodationLimit = accommodationLimit;
  String get transportation => _transportation;
  set transportation(String transportation) => _transportation = transportation;
  ...
  PerDiemModel.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    ...
    _perDiem = json['per_diem'];
    _accommodationLimit = json['accommodation_limit'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['per_diem'] = this._perDiem;
    data['accommodation_limit'] = this._accommodationLimit;
    data['transportation'] = this._transportation;
