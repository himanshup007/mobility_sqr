      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      child: travelTextView(
                          "Visa Request ID",
                          list.details.isNotEmpty &&
                                  IsNullCheck(list.details[0].visaNumber)
                              ? list.details[0].visaNumber
                              : " ",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                    ),
                  ),
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                        child: CustomColumnEditText(
                            "",
                            list.details[0].sourceCity,
                            list.details[0].travellingCountry,
                            "From",
                            1,
                            true)),
                  ),
                  ...
                  Expanded(
                    ...
                    child: Container(
                        child: CustomColumnEditText(
                            "",
                            list.details[0].destinationCity,
                            list.details[0].travellingCountryTo,
                            "To",
                            1,
                            true)),
                  ),
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                        child: CustomColumnEditText(
                            "",
                            getDepartureTime(list.details[0].departureDate),
                            list.details[0].travellingCountry,
                            "Departure",
                            2,
                            false)),
                  ...
                  Expanded(
                    ...
                    child: Container(
                        child: CustomColumnEditText(
                            "",
                            getDepartureTime(list.details[0].returnDate),
                            list.details[0].travellingCountryTo,
                            "Return",
                            2,
                            false)),
                  ...
                  Expanded(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          "${checkAccomodation(list.details[0].isAccmodationRequired)}",
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 14,
                              color: AppConstants.TEXT_BACKGROUND_COLOR),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        showCustomDialogClass(
                            context,
                            AddAgendaView(list.remark,  onclose: () {
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      child: travelTextView(
                          "Name",
                          IsNullCheck(list.details[0].hostHrName)
                              ? list.details[0].hostHrName
                              : " ",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                    ),
                  ),
                  Expanded(
                    ...
                    child: Container(
                        child: travelTextView(
                            "Phone",
                            IsNullCheck(list.details[0].hostPhoneNo)
                                ? list.details[0].hostPhoneNo
                                : " ",
                            AppConstants.TEXT_BACKGROUND_COLOR)),
                  ),
                ],
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      child: travelTextView(
                          "Travelling to",
                          IsNullCheck(list.details[0].isClientLocation)
                              ? isClientLocation(
                                  list.details[0].isClientLocation)
                              : " ",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                    ),
                  ),
                  Expanded(
                    ...
                    child: Container(
                        child: travelTextView(
                            "Address",
                            addressCheck(
                                list.details[0].clientAddress,
                                list.details[0].officeLocation,
                                list.details[0].isClientLocation),
                            AppConstants.TEXT_BACKGROUND_COLOR)),
                  ),
                ],
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    "${checkdependent(list.details[0].isDependent)}",
                    style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                  ),
                ],
              ),
            ),
            !list.details[0].isDependent
                ? Column(
                    children: [
                    ...
                    child: Container(
                        child: travelTextView(
                            ...
                            IsNullCheck(list.homePhoneExt)
                                ? list.homePhoneExt+ "-" + list.homePhoneNumber
                                : " "     ,
                            AppConstants.TEXT_BACKGROUND_COLOR)),
                  ),
                ],
            ...
            Divider(color: AppConstants.TEXT_BACKGROUND_COLOR, thickness: .3),
            Container(
              margin: EdgeInsets.symmetric(horizontal: 5.0.w),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            border:
                                Border.all(color: AppConstants.APP_THEME_COLOR),
                            borderRadius: BorderRadius.all(Radius.circular(5))),
                        child: Row(
                          children: [
                            Text(
            ...
            showcost?Container(
              child: Column(children: [
                ...
                Container(
                  margin:
                      EdgeInsets.symmetric(horizontal: 5.0.w, vertical: .5.h),
                  child: Align(
                ...
                Container(
                  margin:
                      EdgeInsets.symmetric(horizontal: 5.0.w, vertical: 1.0.h),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      travelTextViewHori(
                          "Per-diems",
                          "${IsNullCheck(list.details[0].perDiemCost) ? list.details[0].perDiemCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                      travelTextViewHori(
                          "Airfare",
                          "${IsNullCheck(list.details[0].airfareCost) ? list.details[0].airfareCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                      travelTextViewHori(
                          "Hotel",
                          "${IsNullCheck(list.details[0].hotelCost) ? list.details[0].hotelCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                      travelTextViewHori(
                          "Transportation",
                          "${IsNullCheck(list.details[0].transportationCost) ? list.details[0].transportationCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                      travelTextViewHori(
                          "Total Cost",
                          "${IsNullCheck(list.details[0].totalCost) ? list.details[0].totalCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text("Total Cost(${IsNullCheck(list.expenceCureency)?list.expenceCureency:" "}) : ${IsNullCheck(list.details[0].totalCost)?list.details[0].totalCost: " "} ",
                        style: TextStyle(fontSize: 14)),
                  ),
                ),
              ]),
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children:[
                  Text("Remarks",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color: AppConstants.TEXT_BACKGROUND_COLOR),)
               ,Icon(Icons.note_add,color: AppConstants.APP_THEME_COLOR,)
                ]
                  ...
                  FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      if(body.requestNotes.isNotEmpty){
                        _onLoading();
                        await _apiProvider.Post_Travel_Req_For_Approval(body).then((value) =>
                        ...
                        showDefaultSnackbar(context, "Please provide the remark");
                      }
