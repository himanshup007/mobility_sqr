        ...
        child: ListView(
          ...
          children: [
            ...
            list.details.length > 0
                ? ConstrainedBox(
                    constraints:
                        BoxConstraints(maxHeight: 55.0.h, minHeight: 55.0.h),
                    ...
                    child: Column(children: [
                      ...
                      Container(
                        ...
                        child: RaisedButton(
                          ...
                          child: Text(
                              "Total Cost(${IsNullCheck(list.expenceCureency) ? list.expenceCureency : " "}) : ${IsNullCheck(list.details[0].totalCost) ? list.details[0].totalCost : " "} ",
                              style: TextStyle(fontSize: 14)),
                        ),
                      ),
                    ]),
                              ...
                              FlatButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (body.requestNotes.isNotEmpty) {
                                    _onLoading();
                                    await _apiProvider
                                            .Post_Travel_Req_For_Approval(body)
                                        .then(
                                            (value) => handleNavigation(value))
                                        .catchError((error) {
