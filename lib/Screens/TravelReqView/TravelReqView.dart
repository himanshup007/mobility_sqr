      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            list.details.length>0?ConstrainedBox(
                constraints: BoxConstraints(maxHeight: 55.0.h, minHeight: 55.0.h),
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                        child: CustomColumnEditText(
                                            ...
                                            list.details[index].travellingCountry,
                                            "From",
                                            1,
                                            true)),
                                  ),
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: Container(
                                        child: CustomColumnEditText(
                                            "",
                                            getDepartureTime(list.details[index]
                                                .departureDate),
                                            list.details[index].travellingCountry,
                                            "Departure",
                                            2,
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                        child: travelTextView(
                                            "Phone",
                                            IsNullCheck(
                                                list.details[index].hostPhoneNo)
                                                ? list.details[index].hostPhoneNo
                                                : " ",
                                            AppConstants.TEXT_BACKGROUND_COLOR)),
                                  ),
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                        child: travelTextView(
                                            "Address",
                                            addressCheck(
                                                list.details[index].clientAddress,
                                                list.details[index].officeLocation,
                                                list.details[index].isClientLocation),
                                            AppConstants.TEXT_BACKGROUND_COLOR)),
                                  ),
                                ],
                    ...
                    child: Container(
                      child: Row(
                        children: [
                          ...
                          Text(
                            " ${IsNullCheck(list.isLaptopRequired)
                                ? checkAccomodation(list.isLaptopRequired)
                                : " "}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
              ...
              child: Column(children: [
                ...
                Container(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: travelTextView(
                          "City Name",
                          "${IsNullCheck(list.details[0].destinationCity) ? list
                              .details[0].destinationCity +
                              "(${IsNullCheck(list.expenceCureency) ? list
                                  .expenceCureency : " "})" : " "}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                    ),
                  ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      travelTextViewHori(
                          "Per-diems",
                          "${IsNullCheck(list.details[0].perDiemCost) ? list
                              .details[0].perDiemCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                      travelTextViewHori(
                          "Airfare",
                          "${IsNullCheck(list.details[0].airfareCost) ? list
                              .details[0].airfareCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                      travelTextViewHori(
                          "Hotel",
                          "${IsNullCheck(list.details[0].hotelCost) ? list
                              .details[0].hotelCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                      travelTextViewHori(
                          "Transportation",
                          "${IsNullCheck(list.details[0].transportationCost)
                              ? list.details[0].transportationCost
                              : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                      travelTextViewHori(
                          "Total Cost",
                          "${IsNullCheck(list.details[0].totalCost) ? list
                              .details[0].totalCost : "-"}",
                          AppConstants.TEXT_BACKGROUND_COLOR),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text(
                        "Total Cost(${IsNullCheck(list.expenceCureency) ? list
                            .expenceCureency : " "}) : ${IsNullCheck(list
                            .details[0].totalCost)
                            ? list.details[0].totalCost
                            : " "} ",
                        style: TextStyle(fontSize: 14)),
                  ),
                ),
                        ...
                        FlatButton(
                          ...
                          onPressed: () async {
                            ...
                            if (body.requestNotes.isNotEmpty) {
                              _onLoading();
                              await _apiProvider.Post_Travel_Req_For_Approval(body)
                                  .then((value) => handleNavigation(value))
                                  .catchError((error) {
                              ...
                              showDefaultSnackbar(
                                  context, "Please provide the remark");
                            }
                          },
                        ),
                      ],
    ...
    Widget okButton = FlatButton(
      ...
      onPressed: () {
        Navigator.of(context).pushNamedAndRemoveUntil(
            '/ApprovalsScreen', (Route<dynamic> route) => false);
      },
    );
